...
import { todayMidMs, upcomingEventCount, workStatusCounts } from './derive'
...
export default function KpiOverview() {
  ...
  const wc = workStatusCounts(workItems, todayMidMs())
  ...
  return (
    <CardGrid columns={6}>
      ...
      <KpiCard value={wc.inProgress} unit="건" label="진행중 업무" sub={`지연 ${wc.delayed}건`} icon={<AssignmentIcon />} accentColor="teal" />
