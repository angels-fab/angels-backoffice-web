...
const STATUS: Record<RoadmapStatus, StatusStyle> = {
  ...
  current: {
    ...
    nodeBg: domain.roadmap.currentNodeBg,
    nodeShadow: `0 0 0 6px ${alpha(domain.roadmap.current, 0.16)},0 8px 18px -4px ${alpha(domain.roadmap.currentNodeShadow, 0.55)}`,
  },
  plan: {
    badge: '예정',
    ...
    nodeColor: domain.roadmap.planNodeText,
    nodeBg: 'var(--ink2)',
    nodeShadow: 'none',
  },
}
  ...
  return (
    <Box
      sx={(t) => ({
        ...
        background: domain.roadmap.hero.cardBg[t.palette.mode],
