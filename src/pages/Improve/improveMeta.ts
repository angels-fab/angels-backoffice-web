...
/** 개선제안 상태 — 시트 '상태' 열 */
export type ImpStatus = '접수중' | '검토중' | '완료' | '보류' | '불가'

/** 필터 탭/드롭다운 노출 순서 (전체 탭 없음) */
export const IMP_STATUSES: ImpStatus[] = ['접수중', '검토중', '완료', '보류', '불가']

/** 신규 등록 시 기본 상태 */
export const IMP_STATUS_DEFAULT: ImpStatus = '접수중'

/** 상태 → 색(StatusChip kind). 접수중=초록·검토중=회색·완료=파랑·보류=주황·불가=빨강 */
