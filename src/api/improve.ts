 ...
 * 압정 좌표와 같은 기준이라 해상도가 달라져도 같은 지점에 남는다. 레이어가 **문서에 붙어 있어**
 * 콘텐츠와 함께 스크롤된다(2026-08-11 개선요청 63 — 그전에는 position:fixed 라 뷰포트를 따라다녔다).
 * 폭이 1400이 아닌 화면(/settings 1200, /equipment 데모 1680)에서는 본문 칸과 좌우가 어긋난다 — 알려진 한계.
 *
