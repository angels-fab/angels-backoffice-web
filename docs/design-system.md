...
### DataTable 표 규격 (승인 2026-07-12 · 정렬 보정 2026-07-13)

- 헤더 12px/600/`text.secondary` · 셀 12px · 행 hover · 모바일 가로 스크롤
- **정렬: 긴 본문성 텍스트 열(요청내용·제목)만 좌측, 그 외 짧은 값 열(번호·위치·상태·담당·날짜·첨부)은 전부 중앙** (사용자 확정)
